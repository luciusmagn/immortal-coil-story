...
(defun jrpg-draw-select-bar (x y w &optional (h 24))
  "Highlight behind a selected menu row: a soft fill and a bright left-edge
cursor, so what is selected reads at a glance."
  (claylib/ll:draw-rectangle (round x) (round (- y 3)) (round w) h
                             (claylib::c-ptr (make-color 255 255 255 52)))
  (claylib/ll:draw-rectangle (round x) (round (- y 3)) 3 h
                             (claylib::c-ptr (make-color 255 255 255 220))))
